...
<div class="container">
    ...
    <!-- deo za prikaz svih osvojenih poena -->
    <div class="row " style="background-color:#F0F0F0">
        ...
        <!-- dugme za prelaz na pocetnu stranicu
         vidljivo i gostu i registrovanom igracu
         redirektuje na stranicu koja brise sesiju i redirektuje na pocetnu
         -->
        ...
        <!-- dugme vidljivo samo registrovanom igracu
            apdejtuje poene registrovanog igraca, zatim
            redirektuje na pocetnu stranicu registrovanog igraca
        -->
                <?php
                    if(isset($_SESSION['username'])){
                        echo '<form name="login" action="http://localhost/SlagalicaIgniter/UserController/updatePoints" method="post">
